...
For members receiving Housing Benefit or Universal Credit (if it is a direct payment to the Co-op), the payment due represents the shortfall between the rent charged and the amount paid by Housing Benefit. There are several stages to the arrears procedure:
